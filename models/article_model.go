...
type ArticleModel struct {
	...
	AuthModel     AuthModel        `gorm:"foreignKey:AuthID" json:"-"`              // 文章作者
	...
	Tags          array_type.Array `gorm:"type:string;size:64" json:"tags"` // 文章标签
}

// AfterUpdate 更新的钩子函数  这种更新不太好
